...
class jointDiscretization:
    ...
    def fit(self, data):
        ...
        num_cutpoints = (data.shape[1]-1) * math.ceil(math.log2(sample_size)) if self.pre_discretized else num_cutpoints
        ...
        n_bins = n_bins if self.n_bins else math.ceil(math.log2(sample_size))
        ...
        return self.best_subsetData_list, self.step_mi_list, self.dim_list, self.cutpoint_list
